  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 border-b border-border bg-muted/40 px-4 py-2.5">
        ...
        <div className="flex flex-1 items-center gap-2 rounded-md border border-border bg-background px-2.5 py-1.5 text-xs text-muted-foreground">
      ...
      <div className="flex gap-3 overflow-hidden p-4">
        {COLUMNS.map((column) => (
          <div
            key={column.title}
            className="flex w-[220px] shrink-0 flex-col rounded-lg border border-border bg-muted/30"
          >
